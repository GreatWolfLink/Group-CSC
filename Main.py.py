...
class GUI():
    ...
    # function that displays passed in page
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # calls show frame function to switch page based on which one is pressed
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # generate problem button and label
        ...
        # creating buttoins for equations
    ...
    # Insanciates NumberPad object / number of inputs is passed in first
    ...
    # function for generate problem button
